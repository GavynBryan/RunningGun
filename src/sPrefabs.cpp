...
std::unique_ptr<Entity> sPrefabs::getPlayer()
{
	...
	//set up animations
	AnimPtr _right(new Animation(0, Vec2f(64, 64), 1, true));
	AnimPtr _left(new Animation(1, Vec2f(64, 64), 1, true));
	AnimPtr _walkright(new Animation(6, Vec2f(64, 64), 1, true));
	AnimPtr _walkleft(new Animation(5, Vec2f(64, 64), 1, true));
	AnimPtr _damageright(new Animation(3, Vec2f(64, 64), 1, false, true));
	AnimPtr _damageleft(new Animation(4, Vec2f(64, 64), 1, false, true));
	AnimPtr _shootright(new Animation(7, Vec2f(64, 64), 0, false));
	AnimPtr _shootleft(new Animation(8, Vec2f(64, 64), 0, false));
...
std::unique_ptr<Entity> sPrefabs::getBull()
{
	...
	//setup animations
	AnimPtr _default(new Animation(0, Vec2f(256, 128), 0, true));
	AnimPtr _shoot(new Animation(1, Vec2f(256, 128), 0, false, true));
	AnimPtr _damage(new Animation(2, Vec2f(256, 128), 0, false, true));
	AnimPtr _die(new Animation(3, Vec2f(256, 128), 2, false, true));
...
std::unique_ptr<Entity> sPrefabs::getScorpion()
{
	...
	//setup animations
	AnimPtr _left(new Animation(0, Vec2f(64, 64), 1, true));
	AnimPtr _right(new Animation(1, Vec2f(64, 64), 1, true));
	AnimPtr _damageleft(new Animation(2, Vec2f(64, 64), 0, false));
	AnimPtr _damageright(new Animation(3, Vec2f(64, 64), 0, false));
	_anim->addAnimation("left", std::move(_left));
	_anim->addAnimation("right", std::move(_right));
	_anim->addAnimation("damageleft", std::move(_damageleft));
	_anim->addAnimation("damageright", std::move(_damageright));
